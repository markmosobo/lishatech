...
class CreatePropertiesForSaleFeaturesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('properties_for_sale_features', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('properties_for_sale_features');
    }
}
