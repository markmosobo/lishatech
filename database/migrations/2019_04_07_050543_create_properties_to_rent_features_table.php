...
class CreatePropertiesToRentFeaturesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('properties_to_rent_features', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('properties_to_rent_features');
    }
}
