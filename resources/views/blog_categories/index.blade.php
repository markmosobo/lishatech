@extends('layouts.app')
 @section("pageTitle",'Blog Categorys')
 @section("pageSubtitle",'create, edit, delete blogCategories')
  @section("breadcrumbs")
         <li>Home</li> <li>blogCategories</li>
         @endsection
@section('content')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Create Blog Category</h4>
                    </div>
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
           ...
           <div class="modal-dialog">
               <div class="modal-content">
                   ...
                   <div class="modal-footer">
                       <input type="hidden" id="editDetails" value="{{ url("/blogCategories") }}">
                       <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                       <button type="submit" class="btn btn-primary">Save</button>
                   </div>
               </div>
