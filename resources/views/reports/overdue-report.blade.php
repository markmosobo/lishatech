@extends('layouts.app')
@section("pageTitle",'Overdue Repayments Report')
{{--@section("pageSubtitle",'create, edit, delete Claims')--}}
@section("breadcrumbs")
    <li>Reports</li>
    <li class="active">Overdue Repayments</li>
@endsection
@section('content')
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col text-center">
                ...
                <address>
                    <strong>Overdue Repayments</strong><br>
                        ...
                        @if(count($repayments))
                            @foreach($repayments as $repayment)
                                <tr>
                                    ...
                                    <td>{{ toNumber($repayment->schedule) }}</td>
                                    <td><label class="label label-danger"> {{ \Carbon\Carbon::parse($repayment->due_date)->diffInDays(\Carbon\Carbon::today()) + 1 }}</label></td>
                                    <td>{{ number_format($repayment->balance) }}</td>
                                </tr>
                                @endforeach
                            <tr>
                                <td></td>
