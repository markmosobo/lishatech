                                ...
                                <div class="grid-item staff-item format-standard">
                                    <div class="grid-item-inner">
                                        <a data-toggle="modal" data-target="#team-modal-2736" href="#">
                                            <img src="../../../2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/adore-church-wp/wp-content/uploads/sites/13/2015/01/staff1.jpg"
                                                 class="attachment-600x400 size-600x400 wp-post-image" alt=""
                                                 srcset="https://2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/adore-church-wp/wp-content/uploads/sites/13/2015/01/staff1.jpg 500w, https://2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/adore-church-wp/wp-content/uploads/sites/13/2015/01/staff1-300x180.jpg 300w"
                                                 sizes="(max-width: 500px) 100vw, 500px" />
                                        </a>
                                        <div class="grid-content">
                                            <div class="staff-item-name">
                                                <h5>
                                                    <a data-toggle="modal" data-target="#team-modal-2736" href="#" class="">{{$member->full_name}}</a>
                                                </h5>
                                            ...
                                            <ul class="social-icons-colored">
                                                ...
                                                {{--<li class="flickr"><a href="https://www.flickr.com/" target ="_blank"><i class="fa fa-flickr"></i></a></li>--}}
                                                <li class="email"><a href="mailto:pastor@mail.com"><i class="fa fa-envelope"></i></a></li>
                                            </ul>
                                            <p>
                                               {{$member->description}}
                                            </p>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Church Member</h4>
                                        </div>
                                            ...
                                            <div class="staff-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7 col-sm-6">
                                                        <h3 class="short">{{$member->full_name}}</h3>
                                                        <span class="meta-data">Connections Coordinator </span>
