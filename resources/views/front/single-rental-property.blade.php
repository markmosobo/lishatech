                    ...
                    <div class="row">
                        ...
                        <div class="single-property col-12 mb-50">
                            <div class="property-inner">
                                ...
                                <div class="head">
                                    <div class="left">
                                        <h1 class="title">{{$property->property_title}}</h1>
                                        <span class="location"><img src="{{asset('assets/images/icons/marker.png')}}" alt="">{{$property->address}}</span>
                                    </div>
                                    <div class="right">
                                        <div class="type-wrap">
                                                <span class="price">{{$property->rent}}<span>Month</span></span>
                                ...
                                @else
                                    ...
                                    <div class="sidebar-property">
                                        <div class="image">
                                            ...
                                            <a href="{{url('single-property/'.$property->id)}}"><img src="{{asset('assets/images/property/sidebar-property-2.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><a href="{{url('single-property/'.$property->id)}}">{{$property->property_title}}</a></h5>
                                            <span class="location"><img src="{{asset('assets/images/icons/marker.png')}}" alt="">{{$property->address}}</span>
