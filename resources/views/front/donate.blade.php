    ...
    <div class="lgray-bg breadcrumb-cont">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Adore Church." href="{{url('/')}}" class="home"><span property="name">{{config('app.name')}}</span></a><meta property="position" content="1"></span> &gt; <span property="itemListElement" typeof="ListItem"><span property="name">Donate</span><meta property="position" content="2"></span>          	</ol>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" id="content-col">
                    <h2 class="">Here is how you can donate to our church</h2>
                    <hr class="sm">
