...
@section('content')
    ...
    <div class="page-header parallax clearfix" style="background-image:url(../../../2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/uploads/sites/13/2015/01/ph4.jpg); background-color:; height:px;">
        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="Go to PCEA Gitangu Church." href="{{url('/')}}" class="home">
                            ...
                            <ul class="isotope-grid">
                                ...
                                <li class="col-md-4 col-sm-6 blog-item grid-item format-standard">
                                    <div class="grid-item-inner">
                                        <div class="post-media"><a href="{{url('single-recent-blog/'.$blog->id)}}" class="media-box">
                                                <img src="#" class="post-thumb wp-post-image" alt="" srcset="# 600w, # 272w" sizes="(max-width: 600px) 100vw, 600px" /></a></div>                                <div class="grid-content">
                                            <h3 class="post-title"><a href="{{url('single-recent-blog/'.$blog->id)}}">{{$blog->title}}</a></h3>
                                            <p>{{$blog->body}}</p>                               		<span class="meta-data"><span class="meta-post-date"><i class="fa fa-calendar"></i> January 24, 2018</span><span class="meta-post-author"> by <a href="../author/imicreation/index.html">Admin</a></span></span>                                </div>
                                ...
                                {{--<li class="col-md-4 col-sm-6 blog-item grid-item format-audio">--}}
                                    {{--<div class="grid-item-inner">--}}
                                        {{--<div class="post-media">--}}
                                            {{--<audio class="audio-player" src="http://imicreationlive.com/PCEA Gitangu-church/wp-content/uploads/2015/01/Miaow-02-Hidden.mp3" type="audio/mp3" controls></audio>                                </div>--}}
                                ...
                                {{--<li class="col-md-4 col-sm-6 blog-item grid-item format-gallery">--}}
                                    {{--<div class="grid-item-inner">--}}
                                        {{--<div class="post-media">--}}
                                            {{--<div class="flexslider galleryflex" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes" data-speed=5000><ul class="slides"><li class="item format-standard"><a href="../2018/01/24/gallery-post-format/index.html" class="media-box"><img width="600" height="400" src="../../../2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/uploads/sites/13/2015/01/slide2-600x400.jpg" class="attachment-600x400 size-600x400" alt="" srcset="https://2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/uploads/sites/13/2015/01/slide2-600x400.jpg 600w, https://2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/uploads/sites/13/2015/01/slide2-272x182.jpg 272w" sizes="(max-width: 600px) 100vw, 600px" /></a></li></ul></div>                                </div>--}}
                                        {{--<div class="grid-content">--}}
                                ...
                                {{--<li class="col-md-4 col-sm-6 blog-item grid-item format-video">--}}
                                    {{--<div class="grid-item-inner">--}}
                                        {{--<div class="post-media">--}}
                                            {{--<video width="640" height="360" id="player2" poster="../wp-content/uploads/sites/13/2015/01/echo-hereweare-150x150.jpg" class="video-player" controls preload="none"><source type="video/mp4" src="http://imicreationlive.com/PCEA Gitangu-church/wp-content/uploads/2015/01/echo-hereweare.mp4" /><source type="video/webm" src="http://imicreationlive.com/PCEA Gitangu-church/wp-content/uploads/2015/01/echo-hereweare.webm" /><source type="video/ogg" src="http://imicreationlive.com/PCEA Gitangu-church/wp-content/uploads/2015/01/echo-hereweare.ogv" /><object width="640" height="360" type="application/x-shockwave-flash" data="https://2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/themes/PCEA GitanguChurch/vendor/mediaelement/flashmediaelement.swf">--}}
                                                    {{--<param name="movie" value="https://2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/themes/PCEA GitanguChurch/vendor/mediaelement/flashmediaelement.swf" />--}}
                                                    {{--<param name="flashvars" value="controls=true&amp;file=http://imicreationlive.com/PCEA Gitangu-church/wp-content/uploads/2015/01/echo-hereweare.mp4" /><img src="../../../2ysft2ywl8l3ofc6s43cyjwf-wpengine.netdna-ssl.com/PCEA Gitangu-church-wp/wp-content/uploads/sites/13/2015/01/echo-hereweare-600x360.jpg" class="attachment-600x400 size-600x400 wp-post-image" alt="" />--}}
                                                {{--</object>--}}
                                            {{--</video>                                </div>--}}
                                        {{--<div class="grid-content">--}}
