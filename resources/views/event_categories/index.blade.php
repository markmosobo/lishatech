@extends('layouts.app')
 @section("pageTitle",'Event Categorys')
 @section("pageSubtitle",'create, edit, delete EventCategories')
  @section("breadcrumbs")
         <li>Home</li> <li>EventCategories</li>
         @endsection
@section('content')
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
           ...
           <div class="modal-dialog">
               <div class="modal-content">
                   ...
                   <div class="modal-footer">
                       <input type="hidden" id="editDetails" value="{{ url("/eventCategories") }}">
                       <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                       <button type="submit" class="btn btn-primary">Save</button>
                   </div>
               </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Delete Event Category</h4>
                        </div>
                        <div class="modal-body">
